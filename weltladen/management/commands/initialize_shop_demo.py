...
class Command(BaseCommand):
    help = _("Initialize the workdir to run the demo of weltladen.")
    ...
    def handle(self, verbosity, *args, **options):
        ...
        if os.path.isfile(initialize_file):
            self.stdout.write("Initializing project weltladen")
            call_command('makemigrations', 'weltladen')
            call_command('migrate')
            ...
            self.stdout.write("Project weltladen already initialized")
            call_command('migrate')
