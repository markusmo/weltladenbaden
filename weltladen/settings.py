...
"""
Django settings for weltladen project.
...
STATICFILES_FINDERS = [
    ...
    'weltladen.finders.FileSystemFinder',
    # or 'django.contrib.staticfiles.finders.AppDirectoriesFinder',
    'weltladen.finders.AppDirectoriesFinder',
...
CMS_TEMPLATES = [
    ('weltladen/pages/default.html', _("Default Page")),
]
